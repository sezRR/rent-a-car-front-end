...
export class NavbarComponent implements OnInit {
    ...
    constructor(public location: Location, private router: Router, private storageService: StorageService, private userService:UserService, private toastrService:ToastrService) {
    }
